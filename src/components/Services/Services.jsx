      ...
      <div className="container py-12">
        ...
        >
          <h1 className="text-4xl xl:text-5xl font-bold max-w-[550px]">
            Desperte a criatividade da sua{" "}
            <span className="text-gray-400 underline">Empresa</span>
          </h1>
          <p className="hidden md:block">
            Aprenda como atrair seus <br></br>
            <span className="text-gray-400 underline">Clientes</span>{" "}
          </p>
        </motion.div>
        {/* cards section */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="uppercase font-semibold text-xl">Aprenda fazendo</p>
