      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-[700px] md:min-h-[600px]">
          ...
          <div className="space-y-5 flex flex-col justify-center items-center text-center md:text-left py-20 px-10 md:pr-24 md:py-0 md:px-0 md:items-start">
            ...
            >
              Desbloqueie Uma Paixão, Atividade Paralela, ou Nova{" "}
              <span className="text-gray-400 underline">Profissão</span>
            </motion.h1>
            <motion.p
              ...
              animate="animate"
            >
              Todos os ícones serão substituídos por seus assets. Este é apenas um template.{" "}
            </motion.p>
            <motion.button
